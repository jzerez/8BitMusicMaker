...
home_urls = ["https://www.vgmusic.com/music/console/nintendo/snes/"]
#, "https://www.vgmusic.com/music/console/nintendo/nes/", "https://www.vgmusic.com/music/console/nintendo/gameboy/"]
#Sets basis URL
    ...
    for link in soup.find_all('a'):
        ...
        if url != None:
            ...
            if len(url_split) > 1 and url_split[1] == "mid":
                ...
                if (csv_name not in os.listdir("Training-CSV")) and (midi_name not in os.listdir("Training-MIDI")) :
                    print(url)
